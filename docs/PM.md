...
|---|---|---|
| Activation (install → verdict) | 60% | 75% |
| Share rate (verdict → external share) | 20% | 35% |
| Verdict trust ("sounds like me") | 70% | — |
| Wardrobe activation (≥5 items + ≥1 outfit / 7d) | 40% | — |
| Paywall conversion (download → paid) | 4% | 6% |
| D30 retention (paid) | ≥30% | — |
| k-factor | →0.5, path >1 | — |
