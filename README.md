...
- **Vision:** provider-agnostic (`VISION_PROVIDER`) — default **Gemini 2.0 Flash** (free tier, no billing); OpenAI optional. Bg-removal: Photoroom. Paywall: RevenueCat (dormant — v1 is **free**).
